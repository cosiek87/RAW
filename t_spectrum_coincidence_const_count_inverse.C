...
void tspectrum_coincidence_const_count_inverse()
{
...
///////////////////////////////////////////         Do zmiany            //////////////////////////////////////////////////////////////////////
	...
	Char_t nazwa_pliku_wyjsciowego[200] = "Analysis_coincidence_const_count_inverse_SDataR_sio2_1.root";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (Int_t i = 0; i < nentries; i++)
	{
		...
		if (delta_time < czas_koincydencji[(channel) / 2])
		{
			...
			if (w_zakresie_sigma(energia, channel, centroidy, sigmy, ile_sigma)) continue;
			if (w_zakresie_sigma(energia_other, channel-1, centroidy, sigmy, ile_sigma)) continue;
